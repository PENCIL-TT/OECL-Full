        ...
        <div className="container mx-auto px-4 relative">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              {dbData ? (
                <>
                  {dbData.content_p1 && <p className="text-gray-700 text-lg leading-relaxed whitespace-pre-line">{dbData.content_p1}</p>}
                  {dbData.content_p2 && <p className="text-gray-700 text-lg leading-relaxed mb-4 whitespace-pre-line">{dbData.content_p2}</p>}
                  {dbData.content_p3 && <p className="text-gray-700 text-lg leading-relaxed whitespace-pre-line">{dbData.content_p3}</p>}
                </>
              ) : (
                <>
